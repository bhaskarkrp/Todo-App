...
export const TodoListItem = ({ item, deleteTodo, toggle }) => {
    // console.log(item);
    ...
    return (
        <>
            <li>
                ...
                <p className={!isComplete ? styles.normal : styles.line}>{item.value}</p>
